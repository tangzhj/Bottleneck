            ...
            if len(lines)>2:
                for i in lines:
                    ...
                    if "VarAllele" not in i:
                        ...
                        position = (str(lit[0])+":"+str(lit[1])+":"+str(lit[2])+"/"+str(lit[18]))
                        count = int(str(lit[5]))
                        addtwodimdict(dic_cell,d,position,count)
...
if os.path.exists(Project_infor+"/varition/"+name+"_matrix_count.txt"):                             
    os.system("rm "+Project_infor+"/varition/"+name+"_matrix_count.txt")
else:
    pass 
                             
                            
f = open(Project_infor+"/varition/"+name+"_matrix_count.txt","a")#this is add
