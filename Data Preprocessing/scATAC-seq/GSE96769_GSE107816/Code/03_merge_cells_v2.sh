...
mkdir $p_output
output_tag=$2
res_chrM="/public/home/chenbzh5/pipeline/ATAC_mito_sc/ref/chrM.len"
res_ref="/public/home/chenbzh5/DB/hg19/human_g1k_v37/human_g1k_v37.fasta"
varScan="/public/home/chenbzh5/Tools/VarScan.v2.3.7.jar"
ref_gene_TSS="/public/home/chenbzh5/pipeline/ATAC_mito_sc/ref/hg19_refseq_genes_TSS.bed.filter"
blacklist='/public/home/chenbzh5/pipeline/ATAC_mito_sc/ref/hg19_blacklist.JDB.bed'
# call SNP using merged bam file. mtQ30PE were not re-calibrated  
...
echo $output_path
java -jar /public/home/chenbzh5/Tools/picard-tools-2.4.1/picard.jar CollectInsertSizeMetrics  VALIDATION_STRINGENCY=SILENT I=$p_output/$output_tag.merge.genomeQ30PE.bam  O=$p_output/$output_tag.log H=$p_output/$output_tag.hist.pdf  W=1000 
